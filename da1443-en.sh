...
wget -q -O da1443-en.tar.gz https://github.com/tnan/da1443/raw/master/da1443-en.tar.gz
...
if [ $CMD_LINE -eq 0 ]; then
	...
	echo "4: custombuild 2.0: Not yet recommended, still in testing. Apache 2.4, mod_ruid2, php 7.2. Can be set to use php-FPM. Experts only. Requires pre-release binaries.";
	echo "";
